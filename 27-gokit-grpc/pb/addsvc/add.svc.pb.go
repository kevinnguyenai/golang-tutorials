...
var file_add_svc_proto_rawDesc = []byte{
	...
	0x08, 0x70, 0x62, 0x61, 0x64, 0x64, 0x73, 0x76, 0x63, 0x22, 0x28, 0x0a, 0x0a, 0x53, 0x75, 0x6d,
	...
	,
...
var file_add_svc_proto_goTypes = []interface{}{
	(*SumRequest)(nil),    // 0: pbaddsvc.SumRequest
	(*SumReply)(nil),      // 1: pbaddsvc.SumReply
	(*ConcatRequest)(nil), // 2: pbaddsvc.ConcatRequest
	(*ConcatReply)(nil),   // 3: pbaddsvc.ConcatReply
}
var file_add_svc_proto_depIdxs = []int32{
	0, // 0: pbaddsvc.Add.Add:input_type -> pbaddsvc.SumRequest
	2, // 1: pbaddsvc.Add.Concat:input_type -> pbaddsvc.ConcatRequest
	1, // 2: pbaddsvc.Add.Add:output_type -> pbaddsvc.SumReply
	3, // 3: pbaddsvc.Add.Concat:output_type -> pbaddsvc.ConcatReply
...
func (c *addClient) Add(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumReply, error) {
	out := new(SumReply)
	err := c.cc.Invoke(ctx, "/pbaddsvc.Add/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addClient) Concat(ctx context.Context, in *ConcatRequest, opts ...grpc.CallOption) (*ConcatReply, error) {
	out := new(ConcatReply)
	err := c.cc.Invoke(ctx, "/pbaddsvc.Add/Concat", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Add_Concat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pbaddsvc.Add/Concat",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
